...
const addOne = (arr) => {
  // Solution code here...
  let myArr = arr.map(number => number + 1)
  return myArr;
}
...
const addQuestion = (arr) => {
  // Solution code here...
  let myArr = arr.map(string => string + '?');
  return myArr;
}
...
for (let index = 0; index < arr.length; index++) {
  myArr.push(Math.pow(2, arr[index]));
}
return myArr;
};
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  let myArr = []
  arr.forEach(value => myArr.push(Math.pow(2, value)));
  return myArr;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let myArr = []
  arr.map(value => myArr.push(Math.pow(2, value)));
  return myArr;
};
